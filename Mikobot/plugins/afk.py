...
from Database.mongodb.afk_db import (
    add_afk,
    cleanmode_off,
    cleanmode_on,
    is_afk,
...
from Mikobot.utils.human_read import get_readable_time2
from Mikobot.utils.localization import use_chat_lang
from Mikobot.utils.util import put_cleanmode


# Handle set AFK Command
@capture_err
@app.on_message(filters.command(["afk"], PREFIX_HANDLER))
@use_chat_lang()
...
@app.on_message(filters.command("afkdel", PREFIX_HANDLER) & filters.group)
@use_chat_lang()
